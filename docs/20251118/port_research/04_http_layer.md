...
defmodule Tinkex.API do
  ...
  #
  # - SamplingClient: Uses shared RateLimiter for 429 backoff but does NOT auto-retry.
  #   * Sampling requests call this module with max_retries: 0.
  #   * Callers wrap retries themselves if desired.
