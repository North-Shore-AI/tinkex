defmodule Tinkex.Domain.Futures.Poller do
  @moduledoc """
  ...
  defmodule State do
    ...
    @type t :: %__MODULE__{
            ...
            observer: module() | nil,
            sleep_fun: Tinkex.Domain.Futures.Poller.sleep_fun(),
            http_timeout: pos_integer(),
            poll_timeout: pos_integer() | :infinity,
            poll_backoff: Tinkex.Domain.Futures.Poller.poll_backoff_policy(),
  ...
  defp resolve_config(opts) do
    case Keyword.get(opts, :context) do
      %Context{config: %Config{} = config} -> config
