defmodule Tinkex.Generated.Types.TelemetrySessionEndEvent do
  @moduledoc """
  TelemetrySessionEndEvent type.
  """

  defstruct [:duration, :event, :event_id, :event_session_index, :severity, :timestamp]
  ...
  @doc "Decode a map into a Tinkex.Generated.Types.TelemetrySessionEndEvent struct."
  ...
  @doc "Encode a Tinkex.Generated.Types.TelemetrySessionEndEvent struct into a map."
  @spec encode(t()) :: map()
  ...
  @doc "Create a new Tinkex.Generated.Types.TelemetrySessionEndEvent from a map."
  @spec from_map(map()) :: t()
  ...
  @doc "Create a new Tinkex.Generated.Types.TelemetrySessionEndEvent."
