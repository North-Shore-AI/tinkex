defmodule Tinkex.Generated.Types.TelemetryGenericEvent do
  @moduledoc """
  TelemetryGenericEvent type.
  """
  ...
  def schema do
    Sinter.Schema.define([
      ...
      {:event_data, :any, [optional: true]},
      {:event_id, :any, [required: true]},
      {:event_name, :any, [required: true]},
  ...
  @doc "Decode a map into a Tinkex.Generated.Types.TelemetryGenericEvent struct."
  ...
  @doc "Encode a Tinkex.Generated.Types.TelemetryGenericEvent struct into a map."
  @spec encode(t()) :: map()
  def encode(%__MODULE__{} = struct) do
    %{
      "event" => struct.event,
      "event_data" => struct.event_data,
  ...
  @doc "Create a new Tinkex.Generated.Types.TelemetryGenericEvent from a map."
  @spec from_map(map()) :: t()
  ...
  @doc "Create a new Tinkex.Generated.Types.TelemetryGenericEvent."
