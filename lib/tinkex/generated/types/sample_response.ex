defmodule Tinkex.Generated.Types.SampleResponse do
  @moduledoc """
  SampleResponse type.
  """

  defstruct [:prompt_logprobs, :sequences, :topk_prompt_logprobs, :type]
  ...
  def schema do
    Sinter.Schema.define([
      ...
      {:sequences, :any, [optional: true]},
      {:topk_prompt_logprobs, :any, [optional: true]},
      {:type, :any, [optional: true]}
    ])
  end

  @doc "Decode a map into a Tinkex.Generated.Types.SampleResponse struct."
  ...
  @doc "Encode a Tinkex.Generated.Types.SampleResponse struct into a map."
  @spec encode(t()) :: map()
  def encode(%__MODULE__{} = struct) do
    %{
      "prompt_logprobs" => struct.prompt_logprobs,
      "sequences" => struct.sequences,
  ...
  @doc "Create a new Tinkex.Generated.Types.SampleResponse from a map."
  @spec from_map(map()) :: t()
  ...
  @doc "Create a new Tinkex.Generated.Types.SampleResponse."
