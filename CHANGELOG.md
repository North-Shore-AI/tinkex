...
### Added
- Structured regularizer examples (offline and live) demonstrate KL direction/symmetric variants and entropy temperature scaling.
...
- Structured regularizer examples (offline + live) now exercise all adapters with reference/pair data wiring patterns.
